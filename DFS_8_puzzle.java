...
class DFS_8_puzzle{
    ...
    //checks whether the current state of the puzzle matches the goal state.
    static boolean isGoal(int[][] initial, int[][] goal){
        return Arrays.deepEquals(initial, goal);
    }
    //finds the position of the empty space (represented by 0) in the puzzle grid.
...
//reconstruct from goal to initial
